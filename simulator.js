function runSim(gearTable, baseLine, makeBaseLine) {
  ...
  document.getElementById("statHealth").innerHTML = healthBase + 10*stam;
  document.getElementById("statMana").innerHTML = manaMain;
  document.getElementById("statShadowPower").innerHTML = ShP;
  document.getElementById("statFirePower").innerHTML = FiP;
  document.getElementById("statCritChance").innerHTML = critChance + "%";
  document.getElementById("statHitChance").innerHTML = hit + "%";
  document.getElementById("statHaste").innerHTML = haste;
  document.getElementById("statStam").innerHTML = stam;
  document.getElementById("statInt").innerHTML = intel;
  document.getElementById("statSpirit").innerHTML = spirit;
  document.getElementById("statSpellPen").innerHTML = pen;
  document.getElementById("statHp5").innerHTML = hp5;
  document.getElementById("statMp5").innerHTML = mp5;
  document.getElementById("statShadowMulti").innerHTML = shadowMultiplier;
  document.getElementById("statFireMulti").innerHTML = fireMultiplier;
  document.getElementById("statShadowVuln").innerHTML = shadowVuln*100 + "%";
